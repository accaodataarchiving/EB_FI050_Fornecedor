		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#brcomeldoradobrasilfi050fi050fornecedor-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"brcomeldoradobrasilfi050fi050fornecedor-display": {
								"semanticObject": "brcomeldoradobrasilfi050fi050fornecedor",
								"action": "display",
								"description": "Exibir Dados do Fornecedor",
								"title": "Dados do Fornecedor",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=br.com.eldoradobrasil.fi050.fi050fornecedor",
									"url": sap.ui.require.toUrl("br/com/eldoradobrasil/fi050/fi050fornecedor")
								}
							}
						}
					}
